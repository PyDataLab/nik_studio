  ...
  return (
    <main className={`relative flex flex-col min-h-screen bg-[#0E1011] max-w-[2560px] w-full mx-auto ${inter.variable}`}>
      ...
      <section className="w-full flex flex-col">
        <div className="w-full flex flex-col px-6 sm:px-12 lg:px-24 3xl:px-[120px] pt-40 sm:pt-80 lg:pt-[150px] 3xl:pt-[200px] pb-24 sm:pb-24 lg:pb-[96px] 3xl:pb-[120px] mt-50 sm:mt-0">
        ...
        <div className="w-full h-[1080px] 3xl:h-[1440px] relative overflow-hidden">
          <Image
      ...
      {/* Team Section */}
      <section className="w-full flex flex-col">
        <div className="w-full flex flex-col px-6 sm:px-12 lg:px-24 3xl:px-[120px] py-24 sm:py-24 lg:py-[96px] 3xl:py-[120px] gap-24 sm:gap-24 lg:gap-[96px] 3xl:gap-[120px]">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-8 sm:gap-12 lg:gap-[96px]">
            <span className="text-white/60 text-xl sm:text-2xl lg:text-[30px] 3xl:text-[40px] font-geometria font-normal leading-none">
              Команда
            </span>
            <span className="text-white/60 text-xl sm:text-2xl lg:text-[30px] 3xl:text-[40px] font-geometria font-normal leading-none">
              (01)
          ...
          <h2 className="text-white text-[44px] sm:text-[96px] lg:text-[200px] 2xl:text-[240px] 3xl:text-[280px] font-geometria font-extrabold uppercase leading-[100%]">
            креатив<br />
            опыт<br />
            скорость
          </h2>
        ...
        <div className="w-full flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between">
            <div className="flex flex-col lg:mt-[70px] xl:mt-[140px] 2xl:mt-[285px] 3xl:mt-[320px] px-6 sm:px-12 lg:px-24 3xl:px-[120px] pt-12 sm:pt-24 lg:pt-[160px] 3xl:pt-[200px] pb-16 sm:pb-16 lg:pb-[64px] 3xl:pb-[80px]">
              <h3 className="text-white text-4xl sm:text-5xl lg:text-[72px] xl:text-[80px] 3xl:text-[100px] font-geometria font-bold uppercase leading-[110%]">
                слава никитин
              </h3>
              <div className="mt-4 3xl:mt-6">
                <p className="text-white/60 text-lg sm:text-xl lg:text-[30px] 3xl:text-[36px] font-geometria font-normal leading-none">
              ...
              <div className="mt-5 3xl:mt-8">
                <p className="text-white text-lg sm:text-xl lg:text-[24px] 3xl:text-[32px] font-inter font-normal leading-[170%]">
            ...
            <div className="flex flex-col px-6 sm:px-12 lg:px-24 3xl:px-[120px] py-12 sm:py-24 lg:pt-[96px] 3xl:pt-[120px] lg:pb-[126px] 3xl:pb-[160px] gap-16 sm:gap-16 lg:gap-[64px] 3xl:gap-[80px]">
              <div className="flex flex-col gap-2 sm:gap-2 lg:gap-[8px] 3xl:gap-[12px]">
                <h4 className="text-white text-2xl sm:text-3xl lg:text-[48px] 3xl:text-[60px] font-geometria font-bold uppercase leading-[130%]">
                  нам доверяют лидеры отраслей
                </h4>
                <p className="text-white/60 text-base sm:text-lg lg:text-[20px] 3xl:text-[28px] font-inter font-normal leading-[180%]">
